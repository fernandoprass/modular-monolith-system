...
public interface IPermissionService
{
   ...
   Task<Result<IEnumerable<PermissionDto>>> GetByRoleId(Guid roleId, RolePermissionRequest request, CancellationToken cancellationToken = default);
   Task<Result<IEnumerable<PermissionDto>>> GetAvailablePermissionByRoleIdAsync(Guid roleId, RolePermissionRequest request, CancellationToken cancellationToken = default);
