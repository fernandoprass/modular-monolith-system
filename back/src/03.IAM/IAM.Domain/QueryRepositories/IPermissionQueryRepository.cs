...
public interface IPermissionQueryRepository
{
   ...
   Task<IEnumerable<PermissionDto>> GetByRoleIdAsync(Guid roleId, RolePermissionRequest request, CancellationToken cancellationToken = default);
   Task<IEnumerable<PermissionDto>> GetByAvailablePermissionsRoleIdAsync(Guid roleId, RolePermissionRequest request, CancellationToken cancellationToken = default); 
