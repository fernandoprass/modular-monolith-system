...
public interface ITemplateService
{
   ...
   Task<Result> AddTranslationAsync(Guid id, TemplateTranslationRequest request, CancellationToken cancellationToken = default);
   Task<Result> UpdateTranslationAsync(Guid id, string language, TemplateTranslationRequest request, CancellationToken cancellationToken = default);
