...
- `scr/02.IAM/`: The IAM (Identity and Access Management) module.
- `scr/01.Shared/`: Common utilities packaged as NuGet packages for reuse across modules.
...
## Shared Module
- `scr/01.Shared/`: Common utilities as a NuGet package.
